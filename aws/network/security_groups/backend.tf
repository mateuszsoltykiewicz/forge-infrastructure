# ==============================================================================
# Security Groups Module - Backend Configuration
# ==============================================================================
...
#     #   key = "modules/network/security_groups/terraform.tfstate"
#     #
#     # Customer dedicated VPC (local):
#     #   key = "customers/sanofi/network/security_groups/terraform.tfstate"
#     #
#     # Customer dedicated VPC (regional):
#     #   key = "customers/acme/us-east-1/network/security_groups/terraform.tfstate"
#   }
# }
