# ==============================================================================
# Internet Gateway Module - Backend Configuration
# ==============================================================================
...
#     #   key = "modules/network/internet_gateway/terraform.tfstate"
#     #
#     # Customer dedicated VPC (local):
#     #   key = "customers/sanofi/network/internet_gateway/terraform.tfstate"
#     #
#     # Customer dedicated VPC (regional):
#     #   key = "customers/acme/us-east-1/network/internet_gateway/terraform.tfstate"
#   }
# }
